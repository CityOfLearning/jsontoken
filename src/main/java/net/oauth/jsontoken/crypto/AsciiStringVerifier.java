...
/**
 * A Verifier that can verify Strings (as opposed to byte arrays), assuming that
 * the String contains characters in the US-ASCII charset.
 */
public class AsciiStringVerifier {
	 ...
	 *
	 * @param verifier
	 *            A {@link Verifier} that can verify signatures on byte arrays.
	 */
	 ...
	 *
	 * @param source
	 *            the source that was signed.
	 * @param signature
	 *            the signature on the source.
