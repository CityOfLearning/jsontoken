...
/**
 * A Signer that can sign Strings (as opposed to byte arrays), assuming that the
 * String contains characters in the US-ASCII charset.
 */
public class AsciiStringSigner {
	 ...
	 *
	 * @param signer
	 *            {@link Signer} that can sign byte arrays.
	 */
	 ...
	 *             when the signature cannot be generated.
	 */
