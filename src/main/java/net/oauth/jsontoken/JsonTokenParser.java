...
public class JsonTokenParser {
	 ...
	 *
	 * @param clock
	 *            a clock object that will decide whether a given token is
	 ...
	 * @param checkers
	 *            an array of checkers that validates the parameters in the JSON
	 *            token.
	 */
	 ...
	 *            the token to verify
	 * @param now
	 *            the instant to use as point of reference for current time
